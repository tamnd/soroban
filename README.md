...
| 0010 | [fine-tuning arithmetic](lessons/0010-fine-tuning) | LoRA and QLoRA parameter and memory counting for Llama-2-7B, then a real 4-bit fine-tune on one 4090 | GPU (4090) | done |
